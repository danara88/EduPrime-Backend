...
namespace EduPrime.Infrastructure.Migrations
{
    ...
    [Migration("20230708012321_Initial")]
            ...
            modelBuilder.Entity("EduPrime.Core.Entities.Role", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 7, 19, 23, 20, 812, DateTimeKind.Local).AddTicks(3603));
            ...
            modelBuilder.Entity("EduPrime.Core.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 7, 19, 23, 20, 815, DateTimeKind.Local).AddTicks(5841));
