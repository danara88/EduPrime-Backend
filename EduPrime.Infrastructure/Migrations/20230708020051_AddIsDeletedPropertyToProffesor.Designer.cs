...
namespace EduPrime.Infrastructure.Migrations
{
    ...
    [Migration("20230708020051_AddIsDeletedPropertyToProffesor")]
    partial class AddIsDeletedPropertyToProffesor
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EduPrime.Core.Entities.Role", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 7, 20, 0, 51, 553, DateTimeKind.Local).AddTicks(1572));
            ...
            modelBuilder.Entity("EduPrime.Core.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 7, 20, 0, 51, 555, DateTimeKind.Local).AddTicks(392));
